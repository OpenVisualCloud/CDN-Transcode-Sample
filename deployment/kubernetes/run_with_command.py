...
def configure_live_transcode_args(service_name, deploy_type, image_name):
    ...
    for i in range(int(output_channel)):
        ...
        pods_dict[service_name]["transcode" + str(i)]["codec"] = codec
        ...
        pods_dict[service_name]["transcode" +
                                str(i)]["resolution"] = resolution_dict[resolution_key][1]
        ...
        pods_dict[service_name]["transcode" +
                                str(i)]["protocol"] = protocol_dict[protocol_key]
...
update_yaml.update_yaml(nfs_server, volume_directory,
