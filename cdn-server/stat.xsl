...
<xsl:template match="stream">
    <tr valign="top">
        ...
        <xsl:if test="$tempval = 'Intelligent_1280x720'">
            <td>E5/X264/FFMPEG</td>
        </xsl:if>
        <xsl:if test="$tempval = 'Intelligent_1920x1080'">
            <td>E5/SVT-HEVC/FFMPEG</td>
        </xsl:if>
        <xsl:if test="$tempval = 'Cityscape_2560x1440' or $tempval = 'Cityscape_854x480'">
            <td>VCA2/Vaapi/FFMPEG</td>
        </xsl:if>
    </tr>
